...
// ResolveReferences of this ProjectEnvironment.
func (mg *ProjectEnvironment) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this ProjectIdentity.
func (mg *ProjectIdentity) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
