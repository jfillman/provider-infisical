...
import (
	...
	apisCluster "github.com/jfillman/provider-infisical/apis/cluster"
	apisNamespaced "github.com/jfillman/provider-infisical/apis/namespaced"
	"github.com/jfillman/provider-infisical/config"
	"github.com/jfillman/provider-infisical/internal/clients"
	controllerCluster "github.com/jfillman/provider-infisical/internal/controller/cluster"
	controllerNamespaced "github.com/jfillman/provider-infisical/internal/controller/namespaced"
	"github.com/jfillman/provider-infisical/internal/features"
	"github.com/jfillman/provider-infisical/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(scheme), "Cannot add cluster-scoped Infisical APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(scheme), "Cannot add namespace-scoped Infisical APIs to scheme")
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Infisical APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Infisical APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Infisical controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Infisical controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Infisical controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Infisical controllers")
	}
